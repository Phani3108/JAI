"""jai-mesh — the CAN bus of the JAI platform.
...
design. No database; pure transport. Imports ``jai_manifest`` only (RunContext).
...
from jai_mesh.cards import AgentCard, Hop, Skill, TaskResult
from jai_mesh.mesh import HttpTransport, Mesh
