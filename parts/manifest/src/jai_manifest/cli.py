"""jai-manifest CLI: validate manifests, export JSON Schemas.
...
from jai_manifest.context import RunContext
from jai_manifest.events import AuditEvent
from jai_manifest.manifest import AgentManifest, load_manifest
...
def main() -> None:
    parser = argparse.ArgumentParser(prog="jai-manifest")
