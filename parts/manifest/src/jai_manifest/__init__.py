"""jai-manifest — the contract layer of the JAI platform.
...
from jai_manifest.context import Actor, Role, RunContext
from jai_manifest.events import AuditEvent, Outcome, canonical_json, sha256_hex
from jai_manifest.manifest import (
    AgentManifest,
    AutonomyLevel,
    GuardrailsConfig,
    HITLGate,
